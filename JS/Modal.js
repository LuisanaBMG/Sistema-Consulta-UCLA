...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            var diminutive = row.cells[1].textContent;
            ...
            document.getElementById('Diminutive_Study').value = diminutive;
    ...
    // Handle edit button click for studies
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.view-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            var Firts_Name = row.cells[5].textContent;
            ...
            document.getElementById('Firts_Name').value = Firts_Name;
